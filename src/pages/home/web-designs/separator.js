import styles from '@/styles/home/web-design/separator.module.scss'
...
export default function Separator({showMsg1}) {

    const [showMsg2, setShowMsg2] = useState(false);
    const [showMsg3, setShowMsg3] = useState(false);

    return (
        <div className={`${styles.root} aos-effect3-observer`}>
            <div>
                {showMsg1 &&
